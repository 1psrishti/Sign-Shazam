...
import 'package:integration_app/screens/translate_screen.dart';
import 'package:percent_indicator/linear_percent_indicator.dart';
import 'package:integration_app/helpers/app_helper.dart';
import 'package:integration_app/helpers/camera_helper.dart';
import 'package:integration_app/helpers/tflite_helper.dart';
import 'package:integration_app/models/result.dart';
                        ...
                        Center(
                          child: Row(
                            ...
                            children: [
                              ...
                              FlatButton(
                                onPressed: () {
                                  textString = textString + outputs[index].label.substring(2, outputs[index].label.length);
                                },
                                child: Icon(
                                  Icons.check,
                                  size: 40,
                                ...
                                onPressed: () {
                                  Navigator.of(context).pushReplacement(
                                      new MaterialPageRoute(builder: (BuildContext context) {
                                        return TranslateScreen(text: textString);
                                      }));
                                },
                                child: Icon(
                                  Icons.translate,
